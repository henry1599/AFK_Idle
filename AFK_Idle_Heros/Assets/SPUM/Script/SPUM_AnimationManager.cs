...
public class SPUM_AnimationManager : MonoBehaviour
{
    ...
    public void AddPreset(){
        ...
        SPUM_Preset presetData = new SPUM_Preset
        {
            ...
            PresetName = unit._code,
            Packages = unit.spumPackages
        };
        Preset.Init(presetData, this);
    ...
    public void SavePresetData(SPUM_Prefabs unit)
    {
        SPUM_Preset presetData = new SPUM_Preset
        {
            UnitType = unit.UnitType,
    ...
    public void ResetSelectedStateTypeIndex()
    {
        ...
        var legacyPackage = UnitPackagesData.FirstOrDefault(p => p.Name.Equals("Legacy"));
